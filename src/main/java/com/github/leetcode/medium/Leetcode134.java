 ...
 * <p>
 * You have a car with an unlimited gas tank and it costs cost[i] of gas to travel from station i to its children station (i+1). You begin the journey with an empty tank at one of the gas stations.
 * <p>
 ...
 * <p>
 * Explanation:
 * You can't start at station 0 or 1, as there is not enough gas to travel to the children station.
