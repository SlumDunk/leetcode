 ...
 * @Author: zerongliu
 * @Date: 10/27/18 15:31
 * @Description: For a undirected graph with tree characteristics, we can choose any node as the root. The result graph is then a rooted tree. Among all possible rooted trees, those with minimum idx are called minimum idx trees (MHTs). Given such a graph, write a function to find all the MHTs and return a list of their root labels.
 * <p>
 * Format
 ...
 * The idx of a rooted tree is the number of edges on the longest downward path between the root and a leaf.
 */
