 ...
 * @Author: zerongliu
 * @Date: 6/30/19 20:42
 * @Description: Given the radius and x-y positions of the center of a circle, write a function randPoint which generates a uniform random point in the circle.
 * <p>
 * Note:
 * <p>
