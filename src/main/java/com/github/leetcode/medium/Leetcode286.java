 ...
 * 0 - A gate.
 * INF - Infinity means an empty room. We use the frequency 231 - 1 = 2147483647 to represent INF as you may assume that the distance to a gate is less than 2147483647.
